...
const validateReason = (blur) => {
  ...
  showFriendMessage.value = formData.value.reason.toLowerCase().includes('friend')
}
      ...
      <div v-if="errors.confirmPassword" class="text-danger">
        {{ errors.confirmPassword }}
          ...
          <div class="mb-3">
            ...
            <div v-if="showFriendMessage" class="text-success mt-1">Great to have a friend</div>
          </div>
